...
const pickSet = (Pick, Creator) => ({ data }) => Store.dispatch(Creator(data[Pick]));
...
export async function Merge() {
    ...
    Sub(requests.NEW_USER_MESSAGE).subscribe(pickSet("userMessage", Actions.addUserMessage));
    Sub(requests.NEW_CLIENT_MESSAGE).subscribe(pickSet("clientMessage", Actions.addClientMessage));
