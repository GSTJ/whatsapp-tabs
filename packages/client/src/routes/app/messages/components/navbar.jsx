...
export default () => {
    ...
    const setFoward = useCallback(bool => dispatch(Actions.setFoward(bool)), [dispatch])
    const setSelected = useCallback(value => dispatch(Actions.setSelected(value)), [dispatch])
    const unmarkClient = useCallback(() => unmark({ variables: { client: selected } }), [selected, unmark])
